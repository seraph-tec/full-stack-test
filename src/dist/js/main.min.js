...
function displayCarousel(){$.ajax({url:window.location.href+"/includes/ajax_photos.php",cache:!1}).done(function(o){$("#photosCarousel").html(o)})}function enviaLeadForm(o){$(".btnEnviaForm").text("AGUARDE..."),$.ajax({method:"POST",url:window.location.href+"/includes/ajax_form.php",data:$(o).serialize()}).done(function(o){$(".retornoAjax").hide(),$(".retornoAjax").html(o).show("medium"),$(".btnEnviaForm").text("CADASTRAR")})}function ResTopo(){var o=$(window).height(),e=$(".jumbotron").height();$(".topo").css("height",o),$(".jumbotron").css("margin-top",o/2-e+"px")}$(document).ready(function(){function o(){$("#rua").val(""),$("#cidade").val("")}ResTopo(),displayCarousel(),$(".cep").mask("00000-000"),$(".celphone").mask("(00) 00000-0000"),$("#cep").blur(function(){var e=$(this).val().replace(/\D/g,"");if(""!=e){/^[0-9]{8}$/.test(e)?($("#rua").val("..."),$("#cidade").val("..."),$.getJSON("https://viacep.com.br/ws/"+e+"/json/?callback=?",function(e){"erro"in e?(o(),alert("CEP não encontrado.")):($("#rua").val(e.logradouro),$,$("#cidade").val(e.localidade),$("#uf").val(e.uf))})):(o(),alert("Formato de CEP inválido."))}else o()}),$(".leadForm").on("submit",function(o){o.preventDefault(),enviaLeadForm($(this))})}),$("a").on("click",function(o){o.preventDefault()}),$("a.nav-link, a.cta-hero").on("click",function(o){o.preventDefault();var e=$(this).attr("href");$([document.documentElement,document.body]).animate({scrollTop:$(e).offset().top-70},1300)}),$(window).resize(function(){ResTopo()});